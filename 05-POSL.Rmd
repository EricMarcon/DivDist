...
## Concentration des arbres abattus

Carte de la concentration locale relative cumulée (M) intratype dans un voisinage de 25m autour des arbres abattus.

```{r}
# Calcul de M individuel
M_POSL <- Mhat(POSL_Ab_wmppp, ReferenceType = "Abattu", Individual = TRUE)
# Réduction du jeu de points pour la carte (code temporaire, à automatiser)
POSL_Ab_seuls_wmppp <- POSL_Ab_wmppp[POSL_Ab_wmppp$marks$PointType == "Abattu"]
par(mar=c(0,0,0,0))
library("SpatDiv")
# Carte
MapPlot(M_POSL, POSL_Ab_seuls_wmppp, r=25)
```

En violet : dispersion relative, en vert-jaune-rouge : concentration.
Pas très intéressant.

## Concentration des érables

Carte de la concentration locale relative cumulée (M) intratype dans un voisinage de 25m autour des érables.
...
par(mar=c(0,0,0,0))
# Carte
MapPlot(M_POSL_Erables, POSL_Erables_wmppp, r=25)
# Arbres abattus
BDD_Vivants_et_Abattus_renseignes_POSL %>% 
